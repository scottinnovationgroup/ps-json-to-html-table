...
'metadata.id' => (isset($item['metadata'][0])) ? $item['metadata'][0]['id'] : $item['metadata']['id'],
'metadata.hasParent' => (isset($item['metadata'][0])) ? $item['metadata'][0]['hasParent'] : $item['metadata']['hasParent'] ,
'metadata.parentID' => (isset($item['metadata'][0])) ? $item['metadata'][0]['parentID'] : $item['metadata']['parentID'],
'metadata.type' => (isset($item['metadata'][0])) ? $item['metadata'][0]['type'] : $item['metadata']['type'],
'metadata.level' => (isset($item['metadata'][0])) ? $item['metadata'][0]['level'] : $item['metadata']['level'],
'parentID' => $parentID,
'level' => $level,
];
